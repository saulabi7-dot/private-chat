...
// 채팅 말풍선/사진첩 그리드에 보여줄 아주 작은 미리보기용 프리셋. 실제 원본은
// messages.full_image에 따로 저장되고 라이트박스/다운로드 시에만 불러오므로,
// 목록에 쓰이는 이 썸네일은 화질보다 "가벼움"이 우선이다.
export const CHAT_THUMBNAIL_OPTIONS = { maxDim: 480, quality: 0.55, maxBytes: 20 * 1024, minQuality: 0.35 };
